				...
				<div class="card-body">
					...
					<div class="row">
						...
						<div class="col-lg-6 text-right">
							<a href="layout.php?content=data_hotel_tambah" class="btn btn-success btn-sm">Tambah Data Hotel</a>
						</div>
					</div>
							...
							<tbody>
								...
								<tr>
									...
									<td align="center">
										...
										<a class="btn btn-danger btn-sm" href="layout.php?content=data_hotel_hapus&id_hotel=<?php echo $row['id_hotel']; ?>"
