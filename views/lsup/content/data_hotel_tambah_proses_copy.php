...
if (isset($_POST ['simpan'])) {
	...
	if ($tambah2) {
		echo "<script>document.location.href='layout.php?content=data_hotel&tambah';</script>";
	} else {
		echo "<script>document.location.href='layout.php?content=data_hotel&gagal';</script>";
	}
